...
class FormValidator {
  ...
  setupSelectTextSwap(select) {
    ...
    // When dropdown closes → show short text on selected
    ...
    select.addEventListener('change', () => {
      // Restore all to full first (for next open), then show short on selected
      showFullText();
      // Use rAF to ensure the change is painted before swapping
